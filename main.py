...
# background
BACKGROUND_IMAGE = pygame.image.load(r'C:\Users\harsh\Desktop\python miniproject\background.jpg')

#  BIRD
BIRD_IMAGE = pygame.image.load(r'C:\Users\harsh\Desktop\python miniproject\bird1.png')
bird_x = 50
bird_y = 300
bird_y_change = 0
...
def display_obstacle(height):
    ...
    pygame.draw.rect(SCREEN, OBSTACLE_COLOR, (obstacle_x, height+150, OBSTACLE_WIDTH, 635))
    # print(bottom_obstacle_height)

# COLLISION DETECTION
def collision_detection (obstacle_x, obstacle_height, bird_y, bottom_obstacle_height):
    if obstacle_x >= 50 and obstacle_x <= (50 + 64):
        if bird_y <= obstacle_height  or bird_y >= (bottom_obstacle_height-50):
            return True
    return False
